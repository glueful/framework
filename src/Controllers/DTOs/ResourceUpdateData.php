...
/**
 * Documentation-only request body for {@see \Glueful\Controllers\ResourceController::update()}.
 *
 * The resource endpoints are polymorphic: a single handler updates a record in
 ...
 * legacy comment docblock's `@requestBody data:object="Updated resource data"`.
 */
final class ResourceUpdateData
{
    /**
     * Arbitrary column/value pairs to update (shape depends on the table).
     *

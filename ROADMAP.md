...
- **Scheduled framework jobs keep the application context** — five shipped jobs overrode the
  ...
  the notification retry job failed every tenth minute on a fresh install. All five forward it.
...
- Notes: logging and health payload only; low risk.
